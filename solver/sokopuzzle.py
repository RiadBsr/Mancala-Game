...
class SokoPuzzle:
    ...
    def up(self, wall_space_obstacle):
        ...
        if self.robot_block[robot_x][robot_y] == "B":
            ...
            if self.robot_block[box_x][box_y] != "B" and (
                wall_space_obstacle[box_x][box_y] == " "
                or wall_space_obstacle[box_x][box_y] == "S"
            ):
            ...
            if (
                wall_space_obstacle[robot_x][robot_y] == " "
                or wall_space_obstacle[robot_x][robot_y] == "S"
            ):
                self.robot_position = (robot_x, robot_y)
                self.robot_block[robot_x + 1][robot_y] = " "
                self.robot_block[robot_x][robot_y] = "R"
